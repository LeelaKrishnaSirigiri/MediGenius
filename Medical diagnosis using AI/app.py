...
models = {
    ...
    'heart_disease': pickle.load(open('Medical diagnosis using AI/Models/heart_disease_model.sav', 'rb')),
    'parkinsons': pickle.load(open('Medical diagnosis using AI/Models/parkinsons_model.sav', 'rb')),
    'lung_cancer': pickle.load(open('Medical diagnosis using AI/Models/lungs_disease_model.sav', 'rb')),
    'thyroid': pickle.load(open('Medical diagnosis using AI/Models/Thyroid_model.sav', 'rb'))
}
